<template>
    <div class="modal fade" tabindex="-1" data-bs-backdrop="static" id="createOrUpdateDialog">
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        <input  v-model="ten_khoa_dao_tao" class="form-control" placeholder="Tên khoa">
                    </div>
                </div>
            </div>
        </div>
